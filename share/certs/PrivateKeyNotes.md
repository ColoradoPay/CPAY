...
unlocked to sign the CPAY-Qt.app bundle.
...
allowing somebody to distribute a CPAY-Qt.app or CPAY-qt-setup.exe with a valid
...
that the CPAY-qt.exe file inside the installer had not been tampered with.
