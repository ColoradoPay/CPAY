...
SIGNATUREFILE="http://downloads.sourceforge.net/project/CPAY/CPAY/CPAY-0.8.2/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/CPAY/CPAY/"
VERSIONPREFIX="CPAY-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'CPAY-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[CPAY-]<version>-[rc[0-9]] (example: CPAY-0.7.1-rc1)"
   echo "wget output:"
