TEMPLATE = app
TARGET = ColoradoPayCertificates-qt
macx:TARGET = "ColoradoPayCertificates-Qt"
VERSION = 0.8.0.1
...
contains(CPAY_NEED_QT_PLUGINS, 1) {
DEFINES += CPAY_NEED_QT_PLUGINS
...
src/qt/CPAYaddressvalidator.cpp \
src/alert.cpp \
src/version.cpp \
src/sync.cpp \
src/util.cpp \
...
src/qt/CPAYstrings.cpp \
src/qt/CPAYamountfield.cpp \
src/wallet.cpp \
src/keystore.cpp \
...
# also add new translations to src/qt/CPAY.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/CPAY_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/CPAY-qt.rc
...
macx:ICON = src/qt/res/icons/CPAY.icns
