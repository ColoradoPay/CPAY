...
#ifndef H_CPAY_SCRIPT
#define H_CPAY_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCPAYAddress
 */
...
public:
    ...
    // Pre-version-0.6, CPAY always counted CHECKMULTISIGs
