    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText2  = QChar(0xA9)+QString(" 2016 ") + QString(tr("The ColoradoPayCertificates developers"));
    QString copyrightText3  = QChar(0xA9)+QString(" 2016 ") + QString(tr("CCC"));
