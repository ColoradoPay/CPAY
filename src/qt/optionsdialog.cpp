    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new CPAYUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->CPAYAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting ColoradoPayCertificates."), QMessageBox::Ok);
